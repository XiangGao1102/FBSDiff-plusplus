...
target_prompt = 'water color painting of a young lady'
...
gen_z0 = sampler.decode_with_high_FBS(ref_guidance=intermediates, cond=cond, t_dec=decode_steps,
                                      unconditional_guidance_scale=unconditional_guidance_scale,
                                      unconditional_conditioning=un_cond, hp_percentile=7,
...
Image.fromarray(gen_x0).save('test1_high-FBS_res.jpg')
